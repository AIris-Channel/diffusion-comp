...
if __name__ == "__main__":
    ...
    parser.add_argument('--source_json_dir', type=str, default='test_json_data', help='task json files')
    parser.add_argument('--gen_json_dir', type=str, default='./json_data_out/', help='sample json files')
    parser.add_argument("--out_json_dir", type=str, default="./test_json_out/", help="score detail json ouput")
    parser.add_argument("--bound_json_dir", type=str, default="bound_json_outputs", help="score detail json ouput")
